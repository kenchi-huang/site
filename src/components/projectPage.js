            ...
            <>{
                ...
                <>
                    <div className = "projectScreen-m">
                        <p className = "projectPageTitle-m">Projects</p>
                        <div className = "projectsBox-m">
                            <div className = "projectSection">
                                <button className = "projectButton-m" onClick={(e) => { e.preventDefault(); window.open('https://github.com/danieltsanghang/AirBnB/tree/master', '_blank') }}>
                                    <img className = "projectIcon-m" src={Airbnb}/>
                                    <div className = "projectPopup-m">
                                        <ProjectCircle year = "2020" title = "Airbnb JavaFX Project" description = "An Airbnb Application that grabs data from .csv files. This was the final project of our first year, I was in charge of the implementation of the google street view." mobile = {this.props.mobile}/>
                                    </div>
                                </button>
                            </div>
                            <div className = "projectSection">
                                <button className = "projectButton-m" onClick={(e) => { e.preventDefault(); window.open('https://github.com/lochungtin/Unifin', '_blank') }}>
                                    <img className = "projectIcon-m" src={Unifin}/>
                                        <div className = "projectPopup-m">
                                        <ProjectCircle year = "2020" title = "Unifin" description = "A multi-hackathon-category winning application that utilises the React-Native framework. Developed within a team of 3 and submitted to HackSheffield 6. Won the categories: Best Google Cloud Implementation and Best Fintech Application." mobile = {this.props.mobile}/>
                                    </div>
                                </button>
                            </div>
